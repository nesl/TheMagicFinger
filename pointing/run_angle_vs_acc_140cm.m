...
logfolder = 'C:\Users\Alanwar\Dropbox\gesture\Angle\140cm';
...
cfigure(20,12); 
Angle =     [ 90,120,135,150,180];
accuracy = [97.8261,94.0,90.3,89.74,78.7234];
plot(Angle,accuracy)
grid on
...
%% Anngle
%90  Accuracy: 97.8261
% anchor_ids = [ 6*ones(1,6) 7*ones(1,6) 6*ones(1,6) 7*ones(1,5)...
%                6*ones(1,5) 7*ones(1,6) 6*ones(1,6) 7*ones(1,6)];

%120  Accuracy: 94.0, 0.96
% anchor_ids = [ 6*ones(1,8) 7*ones(1,6) 6*ones(1,6) 7*ones(1,6)...
%                6*ones(1,6) 7*ones(1,6) 6*ones(1,6) 7*ones(1,6)];

%135  Accuracy: 0.887, 0.903,0.919,0.935
anchor_ids = [ 6*ones(1,7) 7*ones(1,7) 6*ones(1,6) 7*ones(1,6)...
               6*ones(1,6) 7*ones(1,6) 6*ones(1,6) 7*ones(1,6) 6*ones(1,6) 7*ones(1,6)];

%150  Accuracy: 0.8974  
anchor_ids = [ 6*ones(1,6) 7*ones(1,6) 6*ones(1,6) 7*ones(1,5)...
               6*ones(1,5) 7*ones(1,5) 6*ones(1,3) 7*ones(1,3) ];

%180 Accuracy: 0.787234
% anchor_ids = [ 6*ones(1,6) 7*ones(1,6) 6*ones(1,6) 7*ones(1,6)...
%                6*ones(1,5) 7*ones(1,6) 6*ones(1,6) 7*ones(1,6)];
