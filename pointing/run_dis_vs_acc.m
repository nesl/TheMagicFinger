...
cfigure(20,12); 
distance = [ 0.3,0.5,1,1.5,2];
accuracy = [76.7,83.3,85.7,89.5,92];
plot(distance,accuracy)
grid on
xlabel('Distance between two devices (m)')
ylabel('Accuracy percentage')

%30cm  Accuracy: 0.767442
%anchor_ids = [ 6*ones(1,7) 7*ones(1,6) 6*ones(1,7) 7*ones(1,6)...
%               6*ones(1,5) 7*ones(1,5) 6*ones(1,6) 7*ones(1,6)];


%50v2 Accuracy: 0.863
% anchor_ids = [ 6*ones(1,9) 7*ones(1,6) 6*ones(1,6) 7*ones(1,5)...
%                6*ones(1,6) 7*ones(1,4) 6*ones(1,5) 7*ones(1,5)];

%50v3 0.833 0.854
% anchor_ids = [ 6*ones(1,6) 7*ones(1,7) 6*ones(1,6) 7*ones(1,6)...
%                 6*ones(1,6) 7*ones(1,6) 6*ones(1,6) 7*ones(1,5)];

%1 v2 0.857
%anchor_ids = [ 6*ones(1,7) 7*ones(1,6) 6*ones(1,3) 7*ones(1,4)...
%               6*ones(1,5) 7*ones(1,5) 6*ones(1,6) 7*ones(1,6)];
...
%70 cm
%2m
%anchor_ids = [ 6*ones(1,6) 7*ones(1,3) 6*ones(1,3) 7*ones(1,3)];
