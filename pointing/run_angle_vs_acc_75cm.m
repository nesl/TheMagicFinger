...
logfolder = 'C:\Users\Alanwar\Dropbox\gesture\Angle\75cm\';

%% Node/Network configuration
configfile = 'config/nodepositions_nesl_angle';
...
%% Anngle
%%90  Accuracy: 0.926829 0.951220
% anchor_ids = [ 6*ones(1,5) 7*ones(1,6) 6*ones(1,6) 7*ones(1,5)...
%                6*ones(1,5) 7*ones(1,5) 6*ones(1,5) 7*ones(1,5)];

%120  Accuracy: 0.903226
% anchor_ids = [ 6*ones(1,4) 7*ones(1,4) 6*ones(1,4) 7*ones(1,5)...
%                6*ones(1,5) 7*ones(1,5) 6*ones(1,5) 7*ones(1,3)];

%135  Accuracy: 0.846154
% anchor_ids = [ 6*ones(1,4) 7*ones(1,2) 6*ones(1,3) 7*ones(1,4)...
%                6*ones(1,1) 7*ones(1,1) 6*ones(1,1) 7*ones(1,3) ];

%150  Accuracy: 0.875000 0.8125  
% anchor_ids = [ 6*ones(1,5) 7*ones(1,2) 6*ones(1,1) 7*ones(1,5)...
%                6*ones(1,5) 7*ones(1,6) 6*ones(1,4) 7*ones(1,5) ];

%180 Accuracy: 0.725 
anchor_ids = [ 6*ones(1,5) 7*ones(1,5) 6*ones(1,3) 7*ones(1,2)...
               7*ones(1,2) 7*ones(1,5) 6*ones(1,4) 6*ones(1,4) 7*ones(1,5) 6*ones(1,2) 7*ones(1,3)];
